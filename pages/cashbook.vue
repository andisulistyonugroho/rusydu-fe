      ...
      <v-card height="80vh">
        <v-card-text>
          <v-alert type="warning" color="primary" variant="tonal" class="mt-2">
            ...
            <NuxtLink to="/accounts"> Klik disini </NuxtLink><br /><br />
            <div>
              "Akun harta adalah media tempat penyimpanan uang atau harta.
              Contoh: Rekening Ayah, Rekening Bunda, Dompet Ayah, Dompet Bunda,
              Amplop, dll"
            </div>
          </v-alert>
        </v-card-text>
