  ...
  <v-container>
    <v-row style="height: 100vh">
          ...
          <v-window-item :value="2">
            <v-form ref="regisF" lazy-validation>
              ...
              <v-checkbox
                ...
                label="Password sudah saya simpan di tempat yang aman"
              ></v-checkbox>
            </v-form>
          </v-window-item>
        </v-window>
      ...
      <v-col v-if="instalationManualIOS" cols="12" md="6" offset-md="3">
        <div class="px-10">
          ...
          <ol>
            ...
            <li>
              Buka menu berbagi:<br />Tap ikon "Bagikan" yang terletak di bagian
              bawah layar (berbentuk persegi dengan panah ke atas).
            </li>
            <li>
              Pilih "Tambahkan ke Layar Utama":<br />Di menu berbagi, scroll ke
              bawah dan pilih opsi "Tambahkan ke Layar Utama".
            </li>
            <li>
      ...
      <v-col cols="12" class="text-center text-caption">
        <template v-if="!$pwa?.isPWAInstalled && !onWeb">
        ...
        <div>version:{{ config.public.theVersion }}</div>
      </v-col>
    </v-row>
  </v-container>
</template>
