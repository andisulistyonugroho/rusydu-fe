  ...
  <div>
    <div class="mx-4 my-4">
      <v-alert
        v-model="alert"
        color="primary"
        text="Merupakan rencana alokasi dana untuk memenuhi kebutuhan bulanan"
    ...
    <div class="mx-4 pb-5">
      ...
      <v-btn variant="tonal" to="/budgeting/copy" class="mt-2" block
        >Salin budget</v-btn
      >
    </div>
    <v-list>
      <v-list-item
        v-for="row in availableMonths"
