...
const doChangePassword = $debounce(
  async () => {
    try {
    ...
    <v-row>
      <template v-if="!changeP">
        ...
        <v-col cols="12" class="text-center">
          <v-btn variant="tonal" block @click="changeP = true"
            >ganti password</v-btn
          >
          <v-btn color="error" block class="mt-3" @click="loggingOut()"
            >logout</v-btn
          >
        </v-col>
      </template>
      <template v-else>
        <v-col cols="12">
          <v-form ref="form">
            <v-text-field
              ...
              label="Password Lama"
              clearable
              :type="tPassOld ? 'text' : 'password'"
              :append-inner-icon="tPassOld ? 'i-mdi-eye' : 'i-mdi-eye-off'"
            ...
            <v-text-field
              ...
              label="Password Baru"
              clearable
              :type="tPassNew ? 'text' : 'password'"
              :append-inner-icon="tPassNew ? 'i-mdi-eye' : 'i-mdi-eye-off'"
              :rules="[
                (v) => !!v || 'Harus diisi',
            ...
            <v-text-field
              ...
              clearable
              :type="tPassReNew ? 'text' : 'password'"
              :append-inner-icon="tPassReNew ? 'i-mdi-eye' : 'i-mdi-eye-off'"
              :rules="[
                (v) => !!v || 'Harus diisi',
        ...
        <v-col cols="12">
          <div class="d-flex justify-space-between">
            ...
            <v-btn color="error" variant="tonal" @click="doChangePassword()"
              >ganti password</v-btn
            >
          </div>
        </v-col>
